...
/** 
 *  xml_handleCount -- Get the number of handle_t used (private method)
 *
 *  @brief  Get the number of handle_t used (private method)
 *  @fn     int xml_handleCount (void)
 *
...
/** 
 *  xml_lookupHandle -- Lookup the handle_t to an Element (private method)
 *
 *  @brief  Lookup the handle_t to an Element (private method)
 *  @fn     handle_t xml_lookupHandle (Element *elem)
 *
...
/** 
 *  xml_setHandle -- Assign the Element a handle_t (private method)
 *
 *  @brief  Assign the Element a handle_t (private method)
 *  @fn     handle_t xml_setHandle (Element *elem)
 *
...
handle_t xml_setHandle (Element * elem)
{
     ...
     */
    xml_handleError ("ERROR: Handle overflow (setHandle).");
    return (0);
}


/** 
 *  xml_freeHandle -- Free a handle for use (private method)
 * 
 *  @brief  Free a handle for use (private method)
 *  @fn     xml_freeHandle (handle_t handle)
 *
...
void xml_freeHandle (handle_t handle)
{
	...
	xml_handleError ("ERROR: Handle overflow (freeHandle).");
}


/** 
 *  xml_getElement -- Get the Element refered to by handle_t (private method)
 *  
 *  @brief Get the Element refered to by handle_t (private method)
 *  @fn    Element *xml_getElement (handle_t handle)
 *
...
Element *xml_getElement (handle_t handle)
{
    ...
    if (handle == 0)
	xml_handleError ("ERROR: Handle NULL.");
    /*return (NULL); */

    else if (handle > handleMax)
	xml_handleError ("ERROR: Handle overflow (getElement).");
...
/** 
 *  xml_handleCleanup -- Free all the handle nodes (private method)
 *
 *  @brief  Free all the handle nodes (private method)
 *  @fn     xml_handleCleanup (void)
 *
 *  @return 		nothing
 */
void xml_handleCleanup (void)
{
    ...
    xml_newHandleTable ();	/*  FIXME ???? */
}


/** 
 *  xml_newHandleTable -- Initialize a handle table (private method)
 *
 *  @brief  Initialize a handle table (private method)
 *  @fn     xml_newHandleTable (void)
 *
 *  @return 		nothing
 */
void xml_newHandleTable (void)
{
    if (handles == NULL)
	handles =
	    (Element **) calloc (HANDLE_INCREMENT, sizeof (Element *));
}


/**
 *  xml_handleError -- Print an error message.
 *
 *  @brief  Print an error message.
 *  @fn     xml_handleError (char *msg)
 *
 *  @return 		nothing
 */
