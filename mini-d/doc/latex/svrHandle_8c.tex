...
\hypertarget{svrHandle_8c_e47012df0d1aa491fa4d099660d40aa4}{
void $\ast$ \textbf{svr\_\-H2P} (handle\_\-t handle)}
\label{svrHandle_8c_e47012df0d1aa491fa4d099660d40aa4}
...
\hypertarget{svrHandle_8c_2d745c019c35cb8c87a6b46f5d93722e}{
...
In this implementation we don't actually re-use a handle unless it is at the end of the list, but we mark all freed handles as NULL in any case so that the handle index remains valid. \hypertarget{svrHandle_8c_2830c3a33d71f99aa5478ad468f8a747}{
...
\begin{Desc}
\item[Returns:]nothing \end{Desc}
\hypertarget{svrHandle_8c_d257115fe5578cfb71989229211c3d0b}{
